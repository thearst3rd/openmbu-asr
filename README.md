...
An auto splitter for OpenMBU. Intends to obsolete the old ASL autosplitter which tails a text file.
...
```
target/wasm32-unknown-unknown/release/openmbu_asr.wasm
```
